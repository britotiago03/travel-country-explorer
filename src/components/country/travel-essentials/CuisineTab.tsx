...
type CuisineTabProps = {
    cuisine: string[];
    countryName: string;
};

export default function CuisineTab({ cuisine, countryName }: CuisineTabProps) {
    return (
        <div>
            <SectionHeader
                icon={
                ...
                title="Local Cuisine"
                subtitle={`Food specialties and dining customs in ${countryName}`}
            />

            <div className="mt-4 space-y-2">
                {cuisine.map((point, index) => (
